                                                    ...
                                                    <table class="image_block block-1" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px"><a href="@setting(url)"
                                                                        target="_blank" style="outline:none"
                                                                        tabindex="-1"><img
                                                                            src="{{ config('app.media_url') . '/assets/media/small/logo' }}/@setting(logo)"
                                                                            style="display: block; height: auto; border: 0; width: 100px; max-width: 100%; border-radius: 15px"
                                                                            width="100" alt="@setting(name)."
                                                                            title="@setting(name)."></a></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                                    ...
                                                                    <div class
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="color:#2b303a;"><span
                                                                                    style="font-size:30px;"><strong>Confirm
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span
                                                                                style="color:#808389;font-size:15px;">Thanks
                                                                                for being a part of @setting(name).
                                                                                You
                                                                                are just one step away from amazing
                                                                                products for your adorables.</span>
                                                                        </p>
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 22.5px;">
                                                                            <span
                                                                                style="color:#808389;font-size:15px;">Click
                                                                                the given button below to confirm your
                                                                                email.</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <table class="button_block block-5" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="center">
                                                                    <a href="{{ route('user.confirm', $user->uid) }}"
                                                                        target="_blank"
                                            ...
                                            <tr>
                                                <td class="column column-1" width="100%"
                                                    ...
                                                    <table class="image_block block-1" width="100%" border="0"
                                                        ...
                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                                        <tr>
                                                            <td class="pad" style="width:20%;padding: 10px;">
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px"><a href="@setting(url)"
                                                                        target="_blank" style="outline:none"
                                                                        tabindex="-1"><img class="big"
                                                                            src="{{ config('app.media_url') . '/assets/media/small/logo' }}/@setting(logo)"
                                                                            style="border-radius:20px;display: block; height: auto; border: 0; width: 416px; max-width: 100%;"
                                                                            width="416" alt="@setting(name). "
                                                                            title="@setting(name). "></a></div>
                                                            </td>
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" style="line-height:10px">
                                                                    <h1>@setting(name)</h1>
                                                                    <p>@setting(address)</p>
                                                                    <p>@setting(email) | @setting(contact)</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span
                                                                                style="color:#95979c;font-size:12px;">@setting(name)
